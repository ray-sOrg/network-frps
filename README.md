...
| 服务           | 域名                    | 端口 | 说明                    |
| -------------- | ----------------------- | ---- | ----------------------- |
| FRPS Dashboard | `frps.tx.ray321.cn`     | 7500 | FRP 服务端管理界面      |
| PVE            | `pve.tx.ray321.cn`      | 6001 | PVE 虚拟化管理界面      |
| iKuai          | `ikuai.tx.ray321.cn`    | 6002 | iKuai 路由器管理界面    |
| iStoreOS       | `istoreos.tx.ray321.cn` | 6003 | iStoreOS 软路由管理界面 |
